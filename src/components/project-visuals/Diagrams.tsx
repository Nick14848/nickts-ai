...
export function NexusVisual() {
  return (
    <Frame label="Abstract system diagram of an internal AI workspace">
      ...
      <text x="70" y="92" fill={muted} fontSize="11" fontFamily="ui-monospace, monospace">
        DEAL DATA
      </text>
      <text x="70" y="196" fill={muted} fontSize="11" fontFamily="ui-monospace, monospace">
        WORKFLOW
      </text>
      <text x="320" y="145" textAnchor="middle" fill={ink} fontSize="11" fontFamily="ui-monospace, monospace">
        NEXUS
      </text>
      <text x="492" y="92" fill={muted} fontSize="11" fontFamily="ui-monospace, monospace">
        AI TOOLS
      </text>
      <text x="486" y="196" fill={muted} fontSize="11" fontFamily="ui-monospace, monospace">
        TEAM VIEW
      </text>
...
export function FeasibilityVisual() {
  return (
    <Frame label="Abstract human-in-the-loop screening workflow">
      ...
      <text x="396" y="92" fill={accent} fontSize="10" fontFamily="ui-monospace, monospace">
        HUMAN
      </text>
    </Frame>
  );
...
export function MarketVisual() {
  return (
    <Frame label="Abstract market intelligence pipeline diagram">
      ...
      <text x="62" y="116" fill={muted} fontSize="11" fontFamily="ui-monospace, monospace">
        BLOOMBERG
      </text>
      <text x="78" y="184" fill={muted} fontSize="11" fontFamily="ui-monospace, monospace">
        NEWS
      </text>
      <text x="278" y="150" fill={ink} fontSize="11" fontFamily="ui-monospace, monospace">
        PIPELINE
      </text>
      <text x="514" y="150" fill={muted} fontSize="11" fontFamily="ui-monospace, monospace">
        BRIEF
      </text>
    </Frame>
  );
